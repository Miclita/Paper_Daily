...
| # | 类别 | 中文标题 | 期刊 | 链接 |
| :--- | :--- | :--- | :--- | :--- |
| 1 | 医疗应用 | 基于深度学习的结直肠癌肝转移灶检测：性能评估、鲁棒性分析及临床意义 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41758034/) |
| 2 | 医疗应用 | 将常规CT检查转化为定量放射学的参考值 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41670446/) |
| 3 | 视觉/核心AI (医疗/运动相关) | 标注层级对多序列MRI模型术前预测肝细胞癌微血管侵犯的影响 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41718534/) |
| 4 | 医疗应用 | 教MRI“阅读”报告：面向大规模脑部MRI的文本—图像对齐 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41636622/) |
| 5 | 视觉/核心AI (医疗/运动相关) | 一种基于三维胸部CT扫描的自监督基础模型用于肺癌诊断与预后预测 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41718531/) |
| 6 | 医疗应用 | 基于深度学习的人工智能模型在多中心CT数据集上对卵巢肿瘤分类性能的评估 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41686074/) |
| 7 | 医疗应用 | 面向儿童患者的个性化深度学习模型：用于肝母细胞瘤在CT及MRI影像中的分割 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41718532/) |
| 8 | 医疗应用 | RSNA乳腺筛查X线摄影癌症检测挑战赛的开源数据集 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41563075/) |
| 9 | 医疗应用 | 一种用于结直肠癌患者增强腹部CT中肝转移灶检测的深度学习算法：与放射科医师的对比... | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41649392/) |
| 10 | 视觉/核心AI (医疗/运动相关) | 放射学中的自主型人工智能：从大语言模型到未来临床整合的演进 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41532836/) |
| 11 | 医疗应用 | 大型语言模型生成标注中的标签噪声对诊断模型性能评估的影响 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41441444/) |
| 12 | 医疗应用 | 利用人工智能推动基于CRISPR的基因组编辑技术发展 | Nature reviews. Genetics | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41254174/) |
| 13 | 医疗应用 | 基于自监督文本-视觉对齐的自动化脑部MRI异常检测：一项多中心研究（ALIGN研... | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41295086/) |
| 14 | 医疗应用 | 基于CT图像分割的全生命周期人体解剖图谱：大规模横断面与纵向分析 | Radiology. Artificial intelligence | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41441443/) |
| 15 | 医疗应用 | 人工智能增强型超声心动图在心血管疾病管理中的应用 | Nature reviews. Cardiology | [PubMed](https://pubmed.ncbi.nlm.nih.gov/40764834/) |
| 16 | 医疗应用 | 多样化的数据库与机器学习模型以缩小RNA结构预测中的泛化差距 | Science advances | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41739924/) |

---

## 3. 文献详情

### 1. 基于深度学习的结直肠癌肝转移灶检测：性能评估、鲁棒性分析及临床意义

- **英语标题**: Deep Learning-based Detection of Colorectal Liver Metastases: Performance, Robustness, and Clinical Implications.
- **期刊**: Radiology. Imaging cancer (2026)
- **作者**: Pritam Mukherjee
- **类别**: 医疗应用
- **原文链接**: https://pubmed.ncbi.nlm.nih.gov/41758034/
...
### 2. 将常规CT检查转化为定量放射学的参考值

- **英语标题**: Turning Routine CT into Reference Values for Quantitative Radiology.
- **期刊**: Radiology. Artificial intelligence (2026)
- **作者**: Yuan Chai, Yu Shi
- **类别**: 医疗应用
- **原文链接**: https://pubmed.ncbi.nlm.nih.gov/41670446/
