...
- **类别**: 医学影像 AI
- **相关性**: 9/10 — 大语言模型用于医学影像报告生成，直接服务于临床放射学诊断，AI是核心贡献。
- **原文链接**: https://pubmed.ncbi.nlm.nih.gov/41983921/

**中文摘要**: 目的：开发一个经过微调的大型语言模型（医学影像报告助手，MIRA），并评估其在多中心数据上生成放射学印象的性能，包括准确性、报告效率和临床适用性。  
材料与方法：整理了一个回顾性的多中心数据集，包含来自中国22个省份42家医院的187万份放射学报告（包括CT、MRI和数字X线摄影数据），时间范围为2019年1月至2024年8月。
