...
| # | 类别 | 相关性 | 中文标题 | 期刊 | 链接 |
| :--- | :--- | :---: | :--- | :--- | :--- |
| 1 | 医学影像 AI | 9/10 | 基于ONCO-RADS的大型语言模型用于全身影像报告中意外发现的提取与分类。 | Radiology. Imaging cancer | [PubMed](https://pubmed.ncbi.nlm.nih.gov/41995468/) |

---

## 3. 文献详情

### 1. 基于ONCO-RADS的大型语言模型用于全身影像报告中意外发现的提取与分类。
...
- **类别**: 医学影像 AI
- **相关性**: 9/10 — LLM用于医学影像报告中的意外发现提取和分类，直接服务于临床诊断，AI是核心贡献。
- **原文链接**: https://pubmed.ncbi.nlm.nih.gov/41995468/

**中文摘要**: 目的 评估基于大语言模型（LLM）的策略在从全身（WB）影像报告中提取和分类意外发现方面的性能，特别是结合肿瘤相关发现报告与数据系统（ONCO-RADS）的策略。  
材料与方法 在这项回顾性多中心研究中，作者纳入了2016年1月至2023年12月期间在转诊中心生成的所有全身MRI报告（内部数据集）。两名观察者提取了所有意外发现，
